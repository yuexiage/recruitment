			...
			<ul class="nav" id="side-menu">
				<li class="nav-header">
					<div class="dropdown profile-element">
						<span><img alt="image" class="img-circle"
							src="{{ asset('images/profile_small.jpg') }}" /></span> <a
							data-toggle="dropdown" class="dropdown-toggle" href="#"> <span
							class="clear"> <span class="block m-t-xs"><strong
									class="font-bold">{{$username or '管理员'}}</strong></span> <span
								class="text-muted text-xs block">{{$rolename or '超级管理员'}}<b class="caret"></b></span>
						</span>
						</a>
				...
				<li class="menu">
					...
					<ul class="nav nav-second-level">
						<li>
							<a class="J_menuItem" href="{{url('admin/departme')}}">部门展示 	</a>
						</li>
					</ul>
				</li>
				<li class="menu">
					...
					<ul class="nav nav-second-level">
						<li>
							<a class="J_menuItem" href="{{url('admin/role')}}">角色管理</a>
						</li>
						<li>
							<a class="J_menuItem" href="{{url('admin/users')}}">用户管理</a>
						</li>
					</ul>
				</li>
				<li class="menu">
				...
				<li class="menu">
					...
					<ul class="nav nav-second-level">
						<li>
							<a class="J_menuItem" href="{{url('admin/config')}}">配置信息</a>
						</li>
					</ul>
				</li>  
				@endif
	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
		...
		<div class="row J_mainContent" id="content-main">
			<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                    src="{{url('admin/indexpage')}}" frameborder="0"
